...
В данном проекте была создана база данных со знаниями о «Школе 21», написаны процедуры и функции для получения информации, а также процедуры и триггеры для её изменения.
...
В этой части создается отдельная БД, скрипт со всеми процедурами находится в файле *part4.sql*.
